...
LEFT JOIN (
    SELECT
        ...
        CD.SUCURSALFACTURA,
        CD.NUMEROFACTURA,
        SUM(CD.IMPORTE) AS TOTAL_NC,
        MAX(FM.TARJETA) AS TARJETA_ASOCIADA
    FROM CRED_DETALLE CD
    JOIN FAC_MAESTRO FM ON FM.TIPO = CD.TIPOFACTURA
                      AND FM.SUCURSAL = CD.SUCURSALFACTURA
                      AND FM.NUMERO = CD.NUMEROFACTURA
    JOIN CRED_MAESTRO CM ON CM.TIPO = CD.TIPOCREDITO
                       AND CM.SUCURSAL = CD.SUCURSALCREDITO
                       AND CM.NUMERO = CD.NUMEROCREDITO
